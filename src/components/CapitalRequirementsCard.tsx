...
/**
 * Server Component - Displays the approximate capital required to purchase a silver round.
 * 
  ...
  return (
    <div className="card p-8 max-w-sm">
      ...
      <p className="text-slate-600 text-sm text-center mb-6">
        {hasValidPrice
          ? `Based on current silver round (${SITE_CONFIG.productSymbol}) ask price:`
          : "To purchase a single silver round:"}
      </p>
      <div className="text-center py-6 rounded-lg bg-slate-100 border border-slate-200">
        {hasValidPrice ? (
          <>
            ...
            <p className="text-slate-600 text-sm mt-2">per 1 oz silver round</p>
          </>
        ) : (
          <>
